Public Class CalculatingAndStandartParams
    ...
    Function setStandart(ByVal f1 As Pressure)
        ...
        f1.EndGraphTimeTF.Text = 40000
        f1.BeginPressTF.Text = 10000
        f1.MinFlowTF.Text = 10 ^ -13
        f1.AlphaTF.Text = -2500
        f1.HKoefTF.Text = 0.5
        f1.TempBeginTF.Text = 293
        f1.TempEndTF.Text = 893
        f1.t1TF.Text = 2000
        f1.tStartHeatRisingTF.Text = 25000
        f1.tEndHeatRisingTF.Text = 28000
        f1.tKatodActivateTF.Text = 30000
        f1.tKatodActiveTF.Text = 31000
        f1.tEndHeatingTF.Text = 35000
        f1.tKatodDisactivateTF.Text = 38000
        f1.tEndTF.Text = 40000
